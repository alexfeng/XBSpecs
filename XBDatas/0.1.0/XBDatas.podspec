#
#  Be sure to run `pod spec lint XBDatas.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author           = { "alexfeng" => "abobet@163.com" }
  # Or just: s.author    = "alexfeng"
  # s.authors            = { "alexfeng" => "abobet@163.com" }
  # s.social_media_url   = "http://twitter.com/alexfeng"
